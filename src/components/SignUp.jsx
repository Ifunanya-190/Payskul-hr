...
const SignUp = () => {
  ...
  // Departments from your specification
  const departments = [
    'Design Department',
    'Sales Department',
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="mb-8">
            <div className="flex flex-col items-start">
              ...
              <div>
                <h1 className="text-lg font-medium text-gray-800">Hello, You are welcome! 👋</h1>
                <p className="text-sm text-gray-600">Please sign up here</p>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="relative mt-1">
                <input
                  ...
                  required
                  className="w-full px-3 py-2.5 text-sm border border-purple-300 rounded-lg focus:ring-2 focus:ring-purple-400 focus:border-purple-500 transition-all duration-200 outline-none"
            ...
            <div className="relative">
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full pl-9 pr-3 py-2.5 text-sm border border-purple-300 rounded-lg focus:ring-2 focus:ring-purple-400 focus:border-purple-500 transition-all duration-200 outline-none"
            ...
            <div className="relative">
              ...
              <div className="relative mt-1">
                <select
                  ...
                  onChange={handleChange}
                  required
                  className="w-full px-3 py-2.5 text-sm border border-purple-300 rounded-lg focus:ring-2 focus:ring-purple-400 focus:border-purple-500 transition-all duration-200 appearance-none bg-white outline-none"
                >
            ...
            <div className="relative">
              ...
              <div className="relative mt-1">
                ...
                <input
                  ...
                  onChange={handleChange}
                  required
                  className="w-full pl-9 pr-10 py-2.5 text-sm border border-purple-300 rounded-lg focus:ring-2 focus:ring-purple-400 focus:border-purple-500 transition-all duration-200 outline-none"
